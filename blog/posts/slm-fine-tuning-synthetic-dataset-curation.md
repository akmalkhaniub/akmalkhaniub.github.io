...
* **Redundant Trajectories**: Synthetic datasets generated by larger models (e.g [1]. GPT-4) contain hundreds of identical prompt patterns, causing model overfitting.
...
* **Standardize Format Wrappers**: Wrap training data inside ChatML tags to train models to output clear system, user, and assistant blocks. [2]
